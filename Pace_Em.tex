...
{A first test of our approach is the EMC effect for $^3He$.} 
 ...
 In Fig. 1 the ratio $R_2^{^3He}/R_2^D$ is shown, with $R_2^A = A~ F_2^A/[Z ~F_2^p + (A-Z)~F_2^n]$.
...
%\left [ |{\bf k}_{\perp}|,x,({\bf  S}\cdot \hat {\bf k}_{\perp})^2,({\bf  S} \cdot {\hat z})^2 \right] $.
...
%, with $L$ for each value of the relative momentum $|k_{23}|$ being the orbital angular momentum of %the third particle in the decomposition of the momentum distribution $n^\tau_{\sigma ' \sigma }(x,{\bf k}%_{\perp};{\cal M}, \bf S) $
