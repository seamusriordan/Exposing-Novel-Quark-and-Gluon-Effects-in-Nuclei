\section{Poincar\'e Covariant Light-Front Spectral Function and Nuclear Structure}
\vspace{-1mm}
...
for a three-fermion system (as the $^3He$ or a nucleon in valence approximation) depends on the  energy $\epsilon$ of the spectator subsystem  and on the LF  momentum $ \tilde{\bm \kappa}$ of the knocked out particle in the {{intrinsic reference frame of the (particle - spectator pair) cluster}}. It is built up from the overlaps of the ground eigenstate of a proper mass operator for the system \cite{PhysRevC.95.014001,Pace:2013bq,Scopetta:2014yoa,Pace:2016eiq}  and
...
can  be expressed through 6 scalar functions, straightforwardly obtained from the system LF wave function as integrals on the relative momentum of the spectator pair.
