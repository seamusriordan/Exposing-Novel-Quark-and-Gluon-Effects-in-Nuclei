...
targets.  These PDFs can in principle be measured for any bound hadronic state.
%A great success of QCD is the prediction of the logarithmic 
%evolution of the PDFs with $Q^2$, the so-called DGLAP evolution.  
\begin{figure}[tbp]
...
When the EMC effect was compared to the $a_2=\sigma_A/\sigma_D$ ratio of
